...
class RadarrManualImportScreen extends ConsumerStatefulWidget {
  const RadarrManualImportScreen({super.key, required this.instance});

  final Instance instance;

  @override
  ConsumerState<RadarrManualImportScreen> createState() =>
      _RadarrManualImportScreenState();
}

class _RadarrManualImportScreenState
    extends ConsumerState<RadarrManualImportScreen> {
