...
class RadarrActivityScreen extends ConsumerWidget {
  const RadarrActivityScreen({super.key, required this.instance});
    ...
    return historyAsync.when(
      ...
      data: (history) {
        ...
        return RefreshIndicator(
          onRefresh: () async => ref.invalidate(radarrHistoryProvider(instance)),
...
class _ActivityIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (icon, color) = switch (eventType.toLowerCase()) {
      ...
      'downloadfolderimported' || 'moviefileimported' => (Icons.file_download_done, Colors.green),
      'moviefiledeleted' || 'moviefiledeleted' => (Icons.delete_outline, Colors.red),
