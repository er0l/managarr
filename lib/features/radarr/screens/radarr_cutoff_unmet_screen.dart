...
class RadarrCutoffUnmetScreen extends ConsumerStatefulWidget {
  const RadarrCutoffUnmetScreen({super.key, required this.instance});

  final Instance instance;

  @override
  ConsumerState<RadarrCutoffUnmetScreen> createState() =>
      _RadarrCutoffUnmetScreenState();
}

class _RadarrCutoffUnmetScreenState
    extends ConsumerState<RadarrCutoffUnmetScreen> {
  ...
  Widget build(BuildContext context) {
    final async = ref.watch(radarrCutoffUnmetProvider(widget.instance));
            ...
            error: (e, _) => Center(
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => ref
                        .invalidate(radarrCutoffUnmetProvider(widget.instance)),
            ...
            data: (movies) {
              ...
              return RefreshIndicator(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, i) => _CutoffMovieTile(
                    movie: filtered[i],
...
class _CutoffMovieTile extends StatelessWidget {
  const _CutoffMovieTile({required this.movie, required this.instance});
