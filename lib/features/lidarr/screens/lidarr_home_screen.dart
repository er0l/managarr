              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ref
                          .read(lidarrSortAscendingProvider(widget.instance.id)
                              .notifier)
                          .state = !ascending;
                      Navigator.pop(ctx);
                    },
      ...
      children: [
        Padding(
          ...
          child: TextField(
              ...
              suffixIcon: query.isNotEmpty
                  ? IconButton(
                      ...
                      onPressed: () {
                        ...
                        ref
                            .read(lidarrSearchQueryProvider(widget.instance.id)
                                .notifier)
                            .state = '';
                      },
                    )
            ...
            onChanged: (v) => ref
                .read(lidarrSearchQueryProvider(widget.instance.id).notifier)
                .state = v,
          ),
        ),
        Expanded(
