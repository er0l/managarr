...
class SonarrReleasesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final releasesAsync = ref.watch(sonarrReleasesProvider((
      instance: instance,
      seriesId: series.id,
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(sonarrReleasesProvider((
              instance: instance,
              seriesId: series.id,
              seasonNumber: seasonNumber,
              episodeId: episodeId,
...
class _ReleaseTileState extends State<_ReleaseTile> {
  ...
  Widget build(BuildContext context) {
    // Need WidgetRef — wrap in Consumer
    return Consumer(
          ...
          subtitle: Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                if ((release.customFormatScore ?? 0) != 0)
                  _Chip(
                    label: 'CF: ${release.customFormatScore}',
                    color: (release.customFormatScore ?? 0) > 0
                        ? AppColors.statusOnline
                        : AppColors.statusOffline,
                  ),
