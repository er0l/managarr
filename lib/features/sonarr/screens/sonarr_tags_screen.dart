...
class SonarrTagsScreen extends ConsumerWidget {
  const SonarrTagsScreen({super.key, required this.instance});
        ...
        error: (e, _) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => ref.invalidate(sonarrTagsProvider(instance)),
              ...
              itemBuilder: (ctx, i) {
                ...
                return ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () =>
                        _confirmDelete(context, ref, tag.id, tag.label),
                  ),
                );
              },
            ),
