...
class _RommCollectionScreenState
    extends ConsumerState<RommCollectionScreen> {
  ...
  Future<void> _loadPage({bool reset = false}) async {
    ...
    try {
      ...
      final results = await api.getCollectionRoms(
      ...
      if (mounted) {
        setState(() {
          _roms = reset ? results : [..._roms, ...results];
