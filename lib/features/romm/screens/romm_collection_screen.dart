...
class RommCollectionScreen extends ConsumerStatefulWidget {
  const RommCollectionScreen({
    super.key,
  ...
  @override
  ConsumerState<RommCollectionScreen> createState() =>
      _RommCollectionScreenState();
}

class _RommCollectionScreenState extends ConsumerState<RommCollectionScreen> {
  ...
  RommCollectionRomsKey get _key => (
  ...
  Widget build(BuildContext context) {
    final romsAsync = ref.watch(rommCollectionRomsProvider(_key));
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.invalidate(rommCollectionRomsProvider(_key)),
          ),
        ],
      ),
      body: Column(
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search in ${widget.collection.name}…',
              ...
              error: (e, _) => Center(
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () =>
                          ref.invalidate(rommCollectionRomsProvider(_key)),
